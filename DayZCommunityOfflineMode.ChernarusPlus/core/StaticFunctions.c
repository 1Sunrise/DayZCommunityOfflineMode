...
// RESPONSIBLE FOR WEAPON BUILDING IN **@PlayerBase** FOR PARAMETER **@Weapon_Base oWpn** (WEAPON BUILDING)
...
// CREATING A CUSTOM CHARACTER SPAWN
...
//------------------------------------------------------------------------------------------------------------------
	...
	/* THIS PARAMETER IS RESPONSIBLE FOR WHETHER THE WEAPON WILL APPEAR IN YOUR HANDS IMMEDIATELY AFTER THE CHARACTER IS SPAWNED. */
...
//------------------------------------------------------------------------------------------------------------------
	...
	/* PARAMETER IS RESPONSIBLE FOR ITEMS IN THE HOTBAR PANEL */

    /* COUNTDOWN STARTS FROM 0. THAT IS, IF IT IS "0", THEN IN THE GAME THE ITEM WILL BE ASSIGNED TO THE KEY "1". 
    IF THE CODE IS "1", THEN IN THE GAME THE ITEM WILL BE ASSIGNED TO KEY "2". AND ETC. */
